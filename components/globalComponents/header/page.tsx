...
const Header: React.FC = () => {
  ...
  const wishList = typeof window !== "undefined" ? localStorage.getItem("wishList") : null;
...
//       if (storedQuantityStorage) {
//         const parsedQuantityStorage = JSON.parse(storedQuantityStorage);
//         const totalQuantity = Object.values(parsedQuantityStorage).reduce((total: any, quantity: any) => {
